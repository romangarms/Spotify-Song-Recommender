...
# Cache for the system account access token
_token_cache = {
    "access_token": None,
    "expires_at": None,
}
...
def get_system_spotify():
    ...
    if not refresh_token:
        raise ValueError(
            ...
            "Please visit /admin/spotify-setup to configure the system account."
        )
...
def get_user_profile(user_id):
    ...
    Returns:
        dict: User profile data with keys: id, display_name, images
